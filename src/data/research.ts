...
export const swarmSupportingResearch: ResearchRef[] = [
  {
    num: 1,
...
export const reactorSupportingResearch: ResearchRef[] = [
  {
    num: 1,
...
export const swarmPaperCount = swarmSupportingResearch.length;
export const reactorPaperCount = reactorSupportingResearch.length;
